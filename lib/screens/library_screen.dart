...
class _LibraryScreenState extends ConsumerState<LibraryScreen> {
    ...
    return SafeArea(
      child: Column(
        ...
        children: [
          ...
          _buildSearchBar(),
          const SizedBox(height: 16),
          _buildTagBar(thoughtsAsync),
          const SizedBox(height: 16),
          Expanded(child: _buildList(thoughtsAsync)),
        ],
      ),
    );
  }
  ...
  Widget _buildTagBar(AsyncValue<List<Thought>> thoughtsAsync) {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final color =
              isAll ? AppColors.accent : AppColors.getTagColor(tag!);
  ...
  Widget _buildList(AsyncValue<List<Thought>> thoughtsAsync) {
